...
class TestDGVAMetadataRetriever(TestCase):
    ...
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_method_type")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_curated_set_link")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_curated_set_name")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_curator_email")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_curator_name")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_detection_description")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_detection_method")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_experiment_resolution")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_experiment_site")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_affiliation_url")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_correction")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_new_feature")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_update_comment")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_submission_version")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_comment_timestamp")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_comment_user_name")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_study_comment")
    @patch("convert_gvf_to_vcf.metadata_retrievers.dgva_metadata.DGVAMetadataRetriever._fetch_creation_date")
